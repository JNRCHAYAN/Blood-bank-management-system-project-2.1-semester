...
public class uho extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/uh.jpg"))); // NOI18N
        jLabel1.setAlignmentX(1.0F);
        jLabel1.setIconTextGap(1);
        jLabel1.setPreferredSize(new java.awt.Dimension(1200, 740));
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(-10, 0, 1680, 770));
        ...
        jMenu4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/dec.png"))); // NOI18N
        jMenu4.setText("Join As A Donar");
 ...
 new allDonorDetails().setVisible(true);         // TODO add your handling code here:
    ...
    private void jMenu4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jMenu4MouseClicked
         new addNewDonor1().setVisible(true);         // TODO add your handling code here:
